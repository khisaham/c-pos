              ...
              <hr />
               ...
               <div class="col-lg-6">
                   ...
                   <asp:DropDownList ID="DDLCustType" class="form-control" runat="server">
                    ...
                    <br /> <asp:RequiredFieldValidator ValidationGroup="vlpg43" ForeColor="Red" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCustName" ErrorMessage="Please Fill Name"></asp:RequiredFieldValidator>
                    <br /> <asp:RequiredFieldValidator  ValidationGroup="vlpg43" ForeColor="Red" ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCustPhone" ErrorMessage="Please Fill Phone"></asp:RequiredFieldValidator>
                    <br />
