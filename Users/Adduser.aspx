              ...
              <div class="col-lg-5">
               ...
               <div class="col-lg-6">
                       ...
                       <asp:Label ID="Label14" runat="server" Font-Size="12px" Text="Address"></asp:Label>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" ValidationGroup="vlpg43"   ControlToValidate="txtShopID" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>                            
                        <asp:TextBox ID="txtShopID" ToolTip="Shop location ID i.e: NY103" class="form-control" ValidationGroup="vlpg43" runat="server"></asp:TextBox>
