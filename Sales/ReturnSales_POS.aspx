...
<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="400px">  <br /> 
       <asp:DataList ID="DataList1" runat="server" Font-Names="Verdana" Font-Size="Small"  RepeatColumns="4" RepeatDirection="Horizontal">
            ...
            <ItemTemplate>
                <div id="pricePlans">
                    <ul id="plans">
                        <li class="plan" style="width:150px">
...
<asp:Panel ID="pnlpopupPayment"  class="panel panel-primary" runat="server" BackColor="White" style="display:none;text-align:left"  Width="420px"  DefaultButton="bntPay" > 
                    ...
                    <div class="panel-SR-mainbody">                   
                        ...
                        <table class="style1">
                            <tr>
                                ...
                                <td  >
                                   <asp:TextBox ID="txtSaleInvoiceNo" ToolTip="Customer paid Amount" runat="server" class="form-control"  AutoPostBack="True"></asp:TextBox> 
