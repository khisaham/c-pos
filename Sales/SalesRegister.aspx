                    ...
                    runat="server" Font-Size="11px"   onrowdeleting="grdSelectedItem_RowDeleting">
                        <Columns>
                            <asp:TemplateField HeaderText="Del">
                                <ItemTemplate>                                    
                                    <asp:LinkButton  ID="LinkDel" runat="server" ForeColor="Red"    Font-Size="15px"  CommandName="Delete"  ToolTip="Delete item" class="glyphicon glyphicon-trash"     />
...
<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="460px">  <br /> 
       <asp:DataList ID="DataList1" runat="server" Font-Names="Verdana" Font-Size="Small"  RepeatColumns="5" RepeatDirection="Horizontal">
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label ForeColor="Black" Font-Size="11px" ID="lblCustID"        runat="server" Text="call"></asp:Label>            
